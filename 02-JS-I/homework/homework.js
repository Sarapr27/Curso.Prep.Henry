...
// REDUX ES UNA LIBRERIA DE JAVASCRIPT PARA GESTIONAR EL ESTADO DE UNA APLICACION.
// REDUX TOOLKIT ES UNA LIBRERIA DE JAVASCRIPT QUE PERMITE SIMPLIFICAR EL USO DE REDUX.
// BIG O NOTATION ES UNA FORMA DE REPRESENTAR LA COMPLEJIDAD DE UN ALGORITMO. LOS TIPOS DE COMPLEJIDAD SON: O(1), O(log n), O(n), O(n log n), O(n^2), O(2^n), O(n!).
...
function esVocal(letra){
  ...
  //Escribe tu código aquí
  if(letra.length > 1){ // si el string es mayor a 1, no se puede procesar.
    return "Dato incorrecto"
  }
  if(letra === "a" || letra === "e" || letra === "i" || letra === "o" || letra === "u"){ // si la letra es una vocal, se muestra el mensaje.
    return "Es vocal"
  }
  return "Dato incorrecto" // si no es una vocal, se muestra el mensaje.
}
